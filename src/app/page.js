...
const DOT_STYLE = {
  ...
  open:   { border: '1.5px solid #E2E2E2', background: 'transparent' },
  empty:  { border: '1.5px solid #E2E2E2', background: 'transparent' },
}

const CHEVRON = (color = '#ADADAD') => (
...
export default function Home() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fff', color: '#000', fontFamily: 'var(--font-sans)' }}>
      <style>{`
        .landing-nav { display:flex; align-items:center; justify-content:space-between; padding:16px 40px; border-bottom:1px solid #E2E2E2; background:#fff; }
        .landing-logo { font-size:18px; font-weight:800; color:#000; letter-spacing:-0.05em; text-decoration:none; }
        .landing-nav-signin { font-size:13px; font-weight:500; color:#545454; background:none; border:none; cursor:pointer; }
        .landing-nav-signin:hover { color:#000; }
        .landing-nav-cta { font-size:13px; font-weight:700; color:#fff; background:#000; border:none; border-radius:500px; padding:9px 18px; cursor:pointer; }
        ...
        .cefr-badge { font-size:10px; font-weight:600; letter-spacing:0.05em; padding:3px 8px; border-radius:4px; background:#F6F6F6; color:#000; border:1px solid #ADADAD; }
        .cefr-badge-active { background:#000; color:#fff; border-color:#000; }

        .landing-h1 { font-size:40px; font-weight:900; line-height:1.08; letter-spacing:-0.03em; color:#000; margin-bottom:16px; }
        .landing-sub { font-size:15px; color:#545454; line-height:1.7; margin-bottom:32px; max-width:400px; }

        .cta-stack { display:flex; flex-direction:column; gap:8px; max-width:340px; }
        .btn-primary-land { display:flex; align-items:center; justify-content:center; min-height:48px; padding:0 28px; background:#000; color:#fff; border:none; border-radius:500px; font-family:var(--font-sans); font-size:14px; font-weight:700; letter-spacing:0.01em; cursor:pointer; width:100%; }
        .btn-ghost-land   { display:flex; align-items:center; justify-content:center; gap:8px; min-height:48px; padding:0 28px; background:#fff; color:#000; border:1.5px solid #E2E2E2; border-radius:500px; font-family:var(--font-sans); font-size:14px; font-weight:500; cursor:pointer; width:100%; }
        .btn-primary-land:hover { opacity:0.85; }
        .btn-ghost-land:hover { border-color:#000; }

        .cred-row { display:flex; gap:16px; margin-top:24px; padding-top:24px; border-top:1px solid #E2E2E2; flex-wrap:wrap; }
        .cred-item { display:flex; align-items:center; gap:6px; font-size:12px; color:#ADADAD; }
        .cred-dot  { width:6px; height:6px; border-radius:50%; background:#000; flex-shrink:0; }

        /* session card */
        .session-card { background:#fff; border:1px solid #E2E2E2; border-radius:12px; overflow:hidden; }
        .card-hdr { display:flex; align-items:center; justify-content:space-between; padding:14px 20px; border-bottom:1px solid #E2E2E2; }
        .concept-eyebrow { font-size:10px; font-weight:600; letter-spacing:0.07em; text-transform:uppercase; color:#ADADAD; margin-bottom:2px; }
        .concept-name { font-size:14px; font-weight:600; color:#000; }
        .level-bdg { font-size:11px; font-weight:600; letter-spacing:0.05em; text-transform:uppercase; padding:3px 8px; border-radius:4px; background:#F6F6F6; color:#000; border:1px solid #ADADAD; }
        .rule-callout { margin:20px 20px 0; padding:12px 14px; background:#F6F6F6; border-left:3px solid #ADADAD; border-radius:0 8px 8px 0; font-size:13px; line-height:1.65; color:#545454; }
        .rule-label { font-size:9px; font-weight:700; letter-spacing:0.08em; text-transform:uppercase; color:#ADADAD; margin-bottom:4px; }
        .rule-callout em { font-family:var(--font-serif); font-style:italic; color:#000; }
        .card-body { padding:20px; }
        .q-label { font-size:10px; font-weight:600; letter-spacing:0.07em; text-transform:uppercase; color:#ADADAD; margin-bottom:10px; }
        .q-text  { font-size:17px; font-weight:600; line-height:1.6; color:#000; margin-bottom:18px; }
        .blank   { display:inline-block; width:72px; border-bottom:2px solid #000; vertical-align:baseline; margin:0 4px; }
        .opts    { display:flex; flex-direction:column; gap:8px; }
        .opt     { width:100%; text-align:left; padding:11px 14px; border-radius:8px; border:1.5px solid #E2E2E2; background:#fff; font-family:var(--font-serif); font-size:14px; color:#000; }
        ...
        .opt-dim       { opacity:0.4; }
        .expl { margin-top:14px; padding:11px 14px; background:#F6F6F6; border-left:3px solid #ADADAD; border-radius:0 8px 8px 0; font-size:13px; line-height:1.6; color:#545454; }
        .expl em { font-family:var(--font-serif); font-style:italic; }
        .card-footer { display:flex; align-items:center; justify-content:space-between; padding:14px 20px; border-top:1px solid #E2E2E2; }
        .prog-dots { display:flex; gap:5px; }
        .pdot { width:7px; height:7px; border-radius:50%; background:#E2E2E2; }
        .pdot-done { background:#000; }
        .pdot-current { background:#ADADAD; outline:2px solid #000; outline-offset:1px; }
        .btn-next { font-size:12px; font-weight:700; padding:0 16px; min-height:36px; background:#000; color:#fff; border:none; border-radius:500px; cursor:pointer; font-family:var(--font-sans); }

        /* grammar map */
        .map-section { background:#F6F6F6; border-top:1px solid #E2E2E2; border-bottom:1px solid #E2E2E2; padding:56px 40px; }
        .sec-eyebrow { font-size:10px; font-weight:700; letter-spacing:0.1em; text-transform:uppercase; color:#ADADAD; text-align:center; margin-bottom:10px; }
        .sec-title   { font-size:26px; font-weight:900; letter-spacing:-0.025em; color:#000; text-align:center; margin-bottom:8px; }
        .sec-sub     { font-size:14px; color:#545454; text-align:center; max-width:460px; margin:0 auto 44px; line-height:1.65; }
        ...
        .lvl-hdr-accessible { font-size:11px; font-weight:600; letter-spacing:0.04em; padding:5px 10px; border-radius:20px; text-align:center; margin-bottom:12px; align-self:center; min-width:70px; background:#fff; color:#000; border:1px solid #E2E2E2; }
        .lvl-hdr-current    { font-size:11px; font-weight:600; letter-spacing:0.04em; padding:5px 10px; border-radius:20px; text-align:center; margin-bottom:12px; align-self:center; min-width:70px; background:#000; color:#fff; border:none; }
        .lvl-hdr-locked     { font-size:11px; font-weight:600; letter-spacing:0.04em; padding:5px 10px; border-radius:20px; text-align:center; margin-bottom:12px; align-self:center; min-width:70px; background:#F6F6F6; color:#ADADAD; border:1px solid #E2E2E2; opacity:0.6; }
        .lvl-sub  { font-size:10px; color:#ADADAD; text-align:center; margin-bottom:14px; }
        .lvl-nodes { display:flex; flex-direction:column; gap:5px; align-items:stretch; }
        .gm-node { font-size:11px; padding:5px 9px; border-radius:5px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; border:1px solid; text-align:left; font-family:var(--font-sans); }
        .gm-node-grey   { background:#F6F6F6; border-color:#E2E2E2; color:#ADADAD; opacity:0.55; }
        .gm-node-open   { background:#fff;     border-color:#E2E2E2; color:#000; }
        ...
        .gm-node-selected { background:#F6F6F6; border:1.5px solid #000; color:#000; font-weight:500; box-shadow:0 0 0 2px #000; }
        .lvl-arrow { width:24px; flex-shrink:0; display:flex; align-items:flex-start; justify-content:center; padding-top:28px; }

        /* mobile map tabs */
        .gm-tabs { display:flex; gap:6px; padding:10px 16px; border-bottom:1px solid #E2E2E2; overflow-x:auto; -webkit-overflow-scrolling:touch; background:#fff; }
        .gm-tabs::-webkit-scrollbar { display:none; }
        .gm-tab { flex-shrink:0; padding:5px 14px; border-radius:20px; font-family:var(--font-sans); font-size:12px; border:1px solid #E2E2E2; background:#fff; color:#000; cursor:pointer; }
        .gm-tab-active  { background:#000; color:#fff; border-color:#000; font-weight:600; }
        .gm-tab-locked  { color:#ADADAD; opacity:0.5; }
        .gm-concept-list { background:#fff; }
        .gm-row { display:flex; align-items:center; gap:12px; padding:13px 16px; border-bottom:1px solid #E2E2E2; }
        .gm-row-selected { background:#F6F6F6; }
        .gm-row-greyed   { opacity:0.5; }
        .gm-dot  { width:8px; height:8px; border-radius:50%; flex-shrink:0; }
        .gm-name { flex:1; font-size:14px; color:#000; font-family:var(--font-sans); }
        ...
        .legend-item { display:flex; align-items:center; gap:6px; font-size:11.5px; color:#545454; }
        .legend-dot  { width:8px; height:8px; border-radius:50%; flex-shrink:0; }

        /* vocabulary section */
        .vocab-section { border-bottom:1px solid #E2E2E2; }
        ...
        .vocab-card    { background:#fff; border:1px solid #E2E2E2; border-radius:12px; overflow:hidden; }
        .vocab-word-hdr { display:flex; align-items:center; justify-content:space-between; padding:16px 20px; border-bottom:1px solid #E2E2E2; }
        .vocab-word-display { font-family:var(--font-serif); font-size:22px; font-weight:700; color:#000; letter-spacing:-0.01em; }
        .vocab-badges { display:flex; align-items:center; gap:6px; }
        .pos-tag { font-size:10px; font-weight:600; letter-spacing:0.06em; text-transform:uppercase; padding:3px 8px; border-radius:4px; background:#F6F6F6; color:#545454; border:1px solid #E2E2E2; }
        .vocab-body { padding:20px; }
        .vocab-prompt { font-size:10px; font-weight:600; letter-spacing:0.07em; text-transform:uppercase; color:#ADADAD; margin-bottom:14px; }
        .vocab-opts { display:flex; flex-direction:column; gap:8px; }
        .vocab-opt { width:100%; text-align:left; padding:11px 14px; border-radius:8px; border:1.5px solid #E2E2E2; background:#fff; font-family:var(--font-sans); font-size:13.5px; color:#000; cursor:default; }
        ...
        .vocab-opt-dim       { opacity:0.35; }
/* how it works */
        .how-wrap { border-bottom:1px solid #E2E2E2; }
        ...
        .step-num   { width:28px; height:28px; border-radius:50%; background:#000; color:#fff; font-size:12px; font-weight:700; display:flex; align-items:center; justify-content:center; margin-bottom:14px; }
        .step-title { font-size:15px; font-weight:700; letter-spacing:-0.01em; color:#000; margin-bottom:6px; }
        .step-desc  { font-size:13.5px; color:#545454; line-height:1.65; margin-bottom:14px; }
        .step-detail { padding:12px 14px; background:#fff; border:1px solid #E2E2E2; border-radius:8px; font-size:12px; color:#545454; line-height:1.5; }
        .step-detail strong { color:#000; font-weight:600; }

        /* proof */
        .proof-section { background:#F6F6F6; border-top:1px solid #E2E2E2; border-bottom:1px solid #E2E2E2; padding:48px 40px; }
        .proof-grid  { display:grid; grid-template-columns:repeat(3,1fr); max-width:960px; margin:0 auto; }
        .proof-item  { padding:8px 36px; border-right:1px solid #E2E2E2; }
        .proof-item:first-child { padding-left:0; }
        .proof-item:last-child  { border-right:none; }
        .proof-val   { font-size:34px; font-weight:900; letter-spacing:-0.04em; color:#000; margin-bottom:4px; line-height:1; }
        .proof-label { font-size:13px; font-weight:600; color:#000; margin-bottom:4px; }
        .proof-sub   { font-size:12px; color:#ADADAD; line-height:1.5; }

        /* final cta */
        .final-cta  { padding:72px 40px; max-width:520px; margin:0 auto; text-align:center; }
        .final-cta h2 { font-size:28px; font-weight:900; letter-spacing:-0.03em; color:#000; margin-bottom:12px; }
        .final-cta p  { font-size:14px; color:#545454; line-height:1.65; margin-bottom:28px; }
        .final-btns { display:flex; flex-direction:column; gap:8px; max-width:320px; margin:0 auto; }

        /* footer */
        .landing-footer { border-top:1px solid #E2E2E2; padding:18px 40px; text-align:center; font-size:12px; color:#ADADAD; }
        ...
        @media (max-width: 768px) {
          ...
          .landing-sub { font-size:14px; max-width:100%; }
          ...
          .proof-item { padding:16px 0; border-right:none; border-bottom:1px solid #E2E2E2; }
      ...
      <nav className="landing-nav">
        <a className="landing-logo" href="/">LexiTree</a>
      ...
      <div style={{ borderBottom: '1px solid #E2E2E2' }}>
        <div className="landing-hero">
          ...
          <div>
            ...
            <div style={{ marginTop: 8, fontSize: 10, color: '#ADADAD', textAlign: 'right', fontStyle: 'italic' }}>
              Lora serif for all French content — a deliberate visual signal
            </div>
          </div>
      ...
      <div className="map-section">
          ...
          <div className="gm-concept-list">
            {MOBILE_LEVELS[mapTab].map((row, i) => (
              <div key={i} className={`gm-row${row.selected ? ' gm-row-selected' : ''}${row.greyed ? ' gm-row-greyed' : ''}`}>
                ...
                <span className="gm-name" style={row.muted ? { color: '#ADADAD' } : {}}>{row.label}</span>
                {!row.greyed && !row.muted && CHEVRON(row.selected ? '#000' : '#ADADAD')}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="map-legend">
          {[
            ...
            { dot: { border: '1.5px solid #E2E2E2', background: 'transparent' }, label: 'not practiced' },
            { dot: { background: '#E2E2E2' },                              label: 'locked' },
          ].map(({ dot, label }) => (
      ...
      <div className="vocab-section">
        <div className="vocab-inner">
          ...
          <div>
            ...
            <h2 style={{ fontSize:26, fontWeight:900, letterSpacing:'-0.025em', color:'#000', marginBottom:10, lineHeight:1.15 }}>
              Grammar-critical words,<br />A1 to C2.
            </h2>
            <p style={{ fontSize:14, color:'#545454', lineHeight:1.7, marginBottom:28, maxWidth:380 }}>
...
function DesktopLevelCol({ type, label, sub, subDark, nodes }) {
  ...
  return (
    <div className="lvl-col">
      ...
      <div className="lvl-sub" style={subDark ? { color: '#000' } : {}}>{sub}</div>
      <div className="lvl-nodes">
